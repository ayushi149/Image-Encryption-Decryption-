...
//java cryptographic extension Engines
import javax.crypto.*;	
import javax.crypto.spec.*;

//Main class which holds the main method
//inherits from JFrame and Implements action listener
class Main extends JFrame implements ActionListener{
    ...
    * */
    ...
    public void DisplayContactinfo(){
  	...
  	"Welcome to JAVA-IMAGE Encryption and Decryption  \n\n"+
	" 5th SEM MINI PROJECT \n"+
	"December 26,2022\n\n"+
    
    "\tCREATED BY:-\n\n"+
  	"\tStudent Name : Ayushi Devliya		\n"+
  	"\tStudent ID : 20012418		\n"+
  	"\tUniversity Rollno. : 2061787	\n"+
  	"\tEmail :ayushidevliya541@gmail.com\n"+
  	"\tphone :+91-730299828\n\n"+
